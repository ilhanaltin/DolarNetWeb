...
export class UserService {
  ...
  register(): Observable<ServiceResult<RegisterResponseDetailsVM>> {
    ...
    return this.baseService.post<RegisterResponseDetailsVM>(environment.Api.Main.Url + environment.Services.User.Register, post);
  }

  login() {
    let post = { UserName: 'ilhanaltin', Password: 'e44f5f0bf7a453a731217f288641ab16', RoleId: 1 }
    
    return this.baseService.post<LoginResponseDetailsVM>(environment.Api.Main.Url + environment.Services.User.Authenticate, post, false);
  }
  ...
  getAll(): Observable<ServiceResult<UserListResponseDetailsVM>> {
    ...
    let myParams = new HttpParams()
      ...
      return this.baseService.get<UserListResponseDetailsVM>(environment.Api.Main.Url + environment.Services.User.GetAllUser,myParams);
  }
  ...
  getById(): Observable<ServiceResult<UserResponseDetailsVM>> {
    ...
    let myParams = new HttpParams()
      ...
      return this.baseService.get<UserResponseDetailsVM>(environment.Api.Main.Url + environment.Services.User.GetById,myParams);
  }
  ...
  post(): Observable<ServiceResult<StandartResponseDetailsVM>> {
    ...
    return this.baseService.post<StandartResponseDetailsVM>(environment.Api.Main.Url + environment.Services.User.UpdateUser,post);
  }
  ...
  delete(): Observable<ServiceResult<StandartResponseDetailsVM>> {
    let myParams = new HttpParams()
      ...
      return this.baseService.delete<StandartResponseDetailsVM>(environment.Api.Main.Url + environment.Services.User.DeleteUser, myParams);
  }
  ...
  changePassword(): Observable<ServiceResult<StandartResponseDetailsVM>> {
    ...
    return this.baseService.post<StandartResponseDetailsVM>(environment.Api.Main.Url + environment.Services.User.ChangePassword, post);
  }
  ...
  CheckEmail(): Observable<ServiceResult<StandartResponseDetailsVM>> {
    ...
    return this.baseService.delete<StandartResponseDetailsVM>(environment.Api.Main.Url + environment.Services.User.CheckEmail, myParams,true);    
  }
}