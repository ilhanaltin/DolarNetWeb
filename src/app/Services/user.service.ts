...
export class UserService {
  ...
  register(): Observable<ServiceResult<RegisterResponseDetailsVM>> {
    ...
    return this.baseService.post<RegisterResponseDetailsVM>(environment.apiURL + environment.Register, post);
  }

  login() {
    let post = { UserName: 'ilhanaltin', Password: 'e44f5f0bf7a453a731217f288641ab16', RoleId: 1 }
    
    return this.baseService.post<LoginResponseDetailsVM>(environment.apiURL + environment.Authenticate, post, false);
  }
  ...
  getAll(): Observable<ServiceResult<UserListResponseDetailsVM>> {
    ...
    let myParams = new HttpParams()
      ...
      return this.baseService.get<UserListResponseDetailsVM>(environment.apiURL + environment.GetAllUser,myParams);
  }
  ...
  getById(): Observable<ServiceResult<UserResponseDetailsVM>> {
    ...
    let myParams = new HttpParams()
      ...
      return this.baseService.get<UserResponseDetailsVM>(environment.apiURL + environment.GetById,myParams);
  }
  ...
  post(): Observable<ServiceResult<StandartResponseDetailsVM>> {
    ...
    return this.baseService.post<StandartResponseDetailsVM>(environment.apiURL + environment.UpdateUser,post);
  }
  ...
  delete(): Observable<ServiceResult<StandartResponseDetailsVM>> {
    let myParams = new HttpParams()
      ...
      return this.baseService.delete<StandartResponseDetailsVM>(environment.apiURL + environment.DeleteUser, myParams);
  }
  ...
  changePassword(): Observable<ServiceResult<StandartResponseDetailsVM>> {
    ...
    return this.baseService.post<StandartResponseDetailsVM>(environment.apiURL + environment.ChangePassword, post);
  }
  ...
  CheckEmail(): Observable<ServiceResult<StandartResponseDetailsVM>> {
    ...
    return this.baseService.delete<StandartResponseDetailsVM>(environment.apiURL + environment.CheckEmail, myParams,true);    
  }
}