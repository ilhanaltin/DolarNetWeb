...
export class UserService {
  ...
  register(): Observable<ServiceResult<RegisterResponseDetailsVM>> {
    ...
    return this.baseService.post<RegisterResponseDetailsVM>(apiConfig.Api.Main.Url + apiConfig.Services.User.Register, post);
  }

  login() {
    let post = { UserName: 'ilhanaltin', Password: 'e44f5f0bf7a453a731217f288641ab16', RoleId: 1 }
    
    return this.baseService.post<LoginResponseDetailsVM>(apiConfig.Api.Main.Url + apiConfig.Services.User.Authenticate, post, false);
  }
  ...
  getById(): Observable<ServiceResult<UserResponseDetailsVM>> {
    ...
    let myParams = new HttpParams()
      ...
      return this.baseService.get<UserResponseDetailsVM>(apiConfig.Api.Main.Url + apiConfig.Services.User.GetById,myParams);
  }
  ...
  post(): Observable<ServiceResult<StandartResponseDetailsVM>> {
    ...
    return this.baseService.post<StandartResponseDetailsVM>(apiConfig.Api.Main.Url + apiConfig.Services.User.UpdateUser,post);
  }
  ...
  delete(): Observable<ServiceResult<StandartResponseDetailsVM>> {
    let myParams = new HttpParams()
      ...
      return this.baseService.delete<StandartResponseDetailsVM>(apiConfig.Api.Main.Url + apiConfig.Services.User.DeleteUser, myParams);
  }
  ...
  changePassword(): Observable<ServiceResult<StandartResponseDetailsVM>> {
    ...
    return this.baseService.post<StandartResponseDetailsVM>(apiConfig.Api.Main.Url + apiConfig.Services.User.ChangePassword, post);
  }
  ...
  CheckEmail(): Observable<ServiceResult<StandartResponseDetailsVM>> {
    ...
    return this.baseService.delete<StandartResponseDetailsVM>(apiConfig.Api.Main.Url + apiConfig.Services.User.CheckEmail, myParams,true);    
  }
}